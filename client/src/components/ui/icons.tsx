...
export function EyeSlashIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9.88 9.88A3 3 0 0 0 12 15a3 3 0 0 0 3-3 3 3 0 0 0-1.12-2.12" />
      <path d="M14.12 14.12A3 3 0 0 1 12 15a3 3 0 0 1-3-3c0-.46.08-.9.24-1.3" />
      <path d="M16.5 7.5A9 9 0 0 1 12 4 9 9 0 0 1 2 12" />
      <path d="M2 2l20 20" />
    </svg>
  )
}
...
export function VideoOffIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m2 2 20 20" />
      <path d="M10.41 10.41A2 2 0 0 0 8 12v2a2 2 0 0 0 2 2h4a2 2 0 0 0 1.59-.78" />
